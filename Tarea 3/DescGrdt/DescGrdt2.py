...
# Section 3. Define relevant parameters to perform the gradient descent
# estimation
old_min = 1  # This is the initial value for x
learningRate = 0.1
precision = 0.0001  # This is the minimum error
# to stop the gradient descent loop


# Section 4. Main loop to descent the gradient
mins = []
while True:
    gradient = AsaUtils.getDerivative2(old_min)
...
# Section 5. Now define visualization function to show animation of the
# minimization steps
...
anim = animation.FuncAnimation(
    fig2, animate, init_func=init, blit=True, frames=len(mins), repeat=False)
